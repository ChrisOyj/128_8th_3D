	...
	: public CUI
{
	...
	enum SIMPLE_TEXTURE	{SIMPLE_LOADING = 119000, SIMPLE_LOADINGBAR, SIMPLE_LOADINGIMAGE, SIMPLE_END};
	enum SIMPLE_FADER {FADER_LOADING = 119100, FADER_ONLYFADEIN, FADER_END};
