...
CDoubleJump_NightGuy::CDoubleJump_NightGuy()
{
}
...
CDoubleJump_NightGuy* CDoubleJump_NightGuy::Create()
{
    CDoubleJump_NightGuy* pInstance = new CDoubleJump_NightGuy();

    if (FAILED(pInstance->Initialize()))
    {
        Call_MsgBox(L"Failed to Initialize : CDoubleJump_NightGuy");
...
HRESULT CDoubleJump_NightGuy::Initialize()
{
    m_iAnimIndex = 29;
    m_eStateType = STATE_DOUBLEJUMP_NIGHTGUY;
...
void CDoubleJump_NightGuy::Enter(CUnit* pOwner, CAnimator* pAnimator)
{
    ...
    _float fJumpPower = pOwner->Get_Status().fJumpPower + 4.f;
...
STATE_TYPE CDoubleJump_NightGuy::Tick(CUnit* pOwner, CAnimator* pAnimator)
{
    CTransform* pTransform = pOwner->Get_Transform();
    CPhysics* pPhyscisCom = pOwner->Get_PhysicsCom();
...
void CDoubleJump_NightGuy::Exit(CUnit* pOwner, CAnimator* pAnimator)
{
    /* 할거없음 */
}

STATE_TYPE CDoubleJump_NightGuy::Check_Condition(CUnit* pOwner, CAnimator* pAnimator)
{
