...
void CParticle::SetUp(_float3 vPos, _float3 vDir, _float3 vScale, _float4 vColor, _float fSpeed, _float fChangeSpeed, _float fFadeOutSpeed)
{
	m_vPos = vPos;
...
void CParticle::Make_WorldMatrix()
{
	...
	*(_float3*)(&m_matWorld.m[0]) *= m_vScale.x;
	*(_float3*)(&m_matWorld.m[1]) *= m_vScale.y;
	*(_float3*)(&m_matWorld.m[2]) *= m_vScale.z;
